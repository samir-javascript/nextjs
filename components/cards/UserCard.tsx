...
const UserCard = async ({user}:props) => {
  ...
  return (
    ...
    >
        <article className="flex flex-col items-center justify-center p-8 w-full rounded-2xl background-light900_dark200 border light-border ">
             <Image alt='user profile picture' src={user.picture} width={100} height={100} className="rounded-full" /> 
